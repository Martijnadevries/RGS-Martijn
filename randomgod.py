...
filename = 'E:/Programmeren/RGP/gods_owned.csv'
...
if file_exists:
    ...
    base_file.to_csv('E:/Programmeren/RGP/gods_owned.csv', index = False)

gods_owned = pd.read_csv('E:/Programmeren/RGP/gods_owned.csv').squeeze().to_list()
...
def main():
    ...
    if navigation_menu == 'Select Gods':
        ...
        gods_pool.to_csv('E:/Programmeren/RGP/gods_owned.csv', index = False)
...
def random_god_pick():
    ...
    file_name = ('E:/Programmeren/RGP/CardArt/' + random_selected_god + ".jpg")
